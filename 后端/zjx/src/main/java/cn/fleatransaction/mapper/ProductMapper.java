...
public interface ProductMapper extends BaseMapper<Product> {
    ...
    @Select("select product.product_id,product.user_id,product_name,product_price,product_description,product_time,product_picture from product,product_pic where product.product_id=product_pic.product_id")
    List<productDto> getProductInfo();

    @Select("select product.product_id,product.user_id,product_name,product_price,product_description,product_time,product_picture,label_name,child_label_name from product,product_pic ,label,child_label,product_label\n" +
    ...
    @Select("select product.product_id,product.user_id,product_name,product_price,product_description,product_time,product_picture,product_phone,product_qq,product_we_chat from product,product_pic where product.product_id=product_pic.product_id and product.product_id=#{productId}")
