...
public interface ProductMapper extends BaseMapper<Product> {
    ...
    @Select("select product_name,product_price,product_description,product_time,product_picture from product,product_pic where product.product_id=product_pic.product_id")
    List<productDto> getProductInfo();

    @Select("select product_name,product_price,product_description,product_time,product_picture,label_name,child_label_name from product,product_pic ,label,child_label,product_label\n" +
